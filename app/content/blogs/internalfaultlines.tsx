...
import BlogLayout from "@/app/editorial/BlogLayout";
import {
  Lead,
  P,
  H2,
} from "@/app/editorial/Typography";
...
export default function InternalFaultLines() {
  return (
    <BlogLayout>
      ...
      {/* SECTION: MIGRATION */}
      <H2>Migration and the Quiet Crisis of Urban India</H2>
      ...
      {/* SECTION: WATER */}
      <H2>Water Disputes: Rivers as Faultlines</H2>
      ...
      {/* CONCLUSION */}
      <H2>Conclusion: Securing Unity Beyond Borders</H2>
